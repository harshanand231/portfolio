  ...
  return (
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-10">
      <div className="w-[100%] h-full flex flex-row items-center justify-between  m-auto px-[10px] gap-6">
        ...
        <a href="https://www.linkedin.com/in/harsh-anand-213a41212/" target="_blank" className=' hover:text-purple-500'><FaLinkedin /></a>
          <a href="https://www.github.com/harshanand231" target="_blank" className=' hover:text-purple-500'><FaGithub /></a>
          <a href="https://discord.gg/" target="_blank" className=' hover:text-purple-500'><FaDiscord /></a>
           <a href="https://www.twitter.com/harshanand840" target="_blank" className=' hover:text-purple-500'><FaTwitter /></a>
        </div>
        ...
        >
          ...
          <a href="https://discord.gg/" target="_blank" className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110'><FaDiscord /></a>
